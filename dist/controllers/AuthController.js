...
const SSOToken_1 = require("../database/models/SSOToken");
...
class AuthController {
    static async register(req, res) {
        ...
        try {
            ...
            institution_address, institution_type, institution_website, institution_description, IsForWhichSystem = UserSession_1.SystemType.ONGERA, } = req.body;
            console.log("\n📋 Extracted Data:");
    ...
    static async login(req, res) {
        ...
        try {
            ...
            const generateSessionToken = () => crypto_1.default.randomBytes(32).toString('hex');
            ...
            const bwengeSession = sessionRepo.create({
                user_id: user.id,
                system: UserSession_1.SystemType.BWENGE_PLUS,
            ...
            const ssoTokenRepo = db_1.default.getRepository(SSOToken_1.SSOToken);
            const ssoRedirectToken = crypto_1.default.randomBytes(32).toString('hex');
            ...
            const responseData = {
                ...
                student_count: ((_c = user.assignedStudents) === null || _c === void 0 ? void 0 : _c.length) || 0,
                has_assigned_instructor: ((_d = user.assignedInstructor) === null || _d === void 0 ? void 0 : _d.length) > 0,
                assigned_students: ((_e = user.assignedStudents) === null || _e === void 0 ? void 0 : _e.map(link => ({
                    student_id: link.student.id,
                    student_name: `${link.student.first_name} ${link.student.last_name}`,
                    student_email: link.student.email,
                    assigned_at: link.assigned_at
                }))) || [],
                assigned_instructor: ((_f = user.assignedInstructor) === null || _f === void 0 ? void 0 : _f.length) > 0 ? {
