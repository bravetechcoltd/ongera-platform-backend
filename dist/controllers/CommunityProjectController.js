...
exports.CommunityProjectController = void 0;
...
const NewsProjectCreatedTemplate_1 = require("../helpers/NewsProjectCreatedTemplate");
const CommunityPost_1 = require("../database/models/CommunityPost");
const SubscribeController_1 = require("./SubscribeController");
class CommunityProjectController {
    static async getCommunityProjects(req, res) {
        try {
            ...
            console.log("✅ Community found:", {
                exists: !!community,
                id: community === null || community === void 0 ? void 0 : community.id,
                name: community === null || community === void 0 ? void 0 : community.name,
                post_count: community === null || community === void 0 ? void 0 : community.post_count
            });
            if (!community) {
            ...
            const directProjectsQuery = projectRepo.createQueryBuilder("project")
                ...
                .andWhere("project.status = :status", { status: ResearchProject_1.ProjectStatus.PUBLISHED });
            ...
            const linkedPostsQuery = postRepo.createQueryBuilder("post")
                ...
                .andWhere("linked_project.status = :status", { status: ResearchProject_1.ProjectStatus.PUBLISHED });
    ...
    static async createCommunityProject(req, res) {
        var _a, _b, _c, _d, _e, _f, _g;
        try {
            const { communityId } = req.params;
            const userId = req.user.userId;
            const { title, abstract, full_description, research_type, visibility, collaboration_status, tags, field_of_study, publication_date, doi, academic_level } = req.body;
            ...
            console.log("📥 Request Data:", {
                ...
                hasProjectFile: !!(req.files && req.files.project_file),
                hasCoverImage: !!(req.files && req.files.cover_image),
                hasAdditionalFiles: !!(req.files && req.files.additional_files)
            });
            ...
            console.log("✅ Project object created:", {
                ...
                communityId: (_d = project.community) === null || _d === void 0 ? void 0 : _d.id
            });
            ...
            console.log("🔍 Database verification:", {
                projectId: verifyProject === null || verifyProject === void 0 ? void 0 : verifyProject.id,
                hasCommunityId: !!(verifyProject === null || verifyProject === void 0 ? void 0 : verifyProject.community_id),
                communityIdValue: verifyProject === null || verifyProject === void 0 ? void 0 : verifyProject.community_id
            });
            // Step 8: Handle tags
            ...
            console.log("✅ Complete project fetched:", {
                id: completeProject === null || completeProject === void 0 ? void 0 : completeProject.id,
                hasCommunity: !!(completeProject === null || completeProject === void 0 ? void 0 : completeProject.community),
                communityName: (_e = completeProject === null || completeProject === void 0 ? void 0 : completeProject.community) === null || _e === void 0 ? void 0 : _e.name,
                tagCount: (_f = completeProject === null || completeProject === void 0 ? void 0 : completeProject.tags) === null || _f === void 0 ? void 0 : _f.length,
                fileCount: (_g = completeProject === null || completeProject === void 0 ? void 0 : completeProject.files) === null || _g === void 0 ? void 0 : _g.length
            });
                ...
                if (membersToNotify.length === 0) {
                    ...
                    for (let i = 0; i < membersToNotify.length; i++) {
                        ...
                        try {
                            ...
                            // Generate email HTML
                            const emailHtml = NewsProjectCreatedTemplate_1.NewsProjectCreatedTemplate.getProjectCreatedTemplate(projectData, memberData);
            ...
            try {
                ...
                SubscribeController_1.SubscribeController.notifyNewProject(subscriberNotificationData)
                    .catch(err => {
...
exports.CommunityProjectController = CommunityProjectController;
