        ...
        try {
            ...
            if (community_id) {
                ...
                const events = await attendeeRepo
                    ...
                    .getMany();
                // FIX: Use class name instead of 'this'
                statistics = MonthlyStarTrackerController.calculateUserScore(projects, blogs, events, ((_a = user.followers) === null || _a === void 0 ? void 0 : _a.length) || 0, month, year);
            }
            else {
                // All-platform stats
                // FIX: Use class name instead of 'this'
                statistics = MonthlyStarTrackerController.calculateUserScore(user.projects || [], user.blog_posts || [], user.eventAttendances || [], ((_b = user.followers) === null || _b === void 0 ? void 0 : _b.length) || 0, month, year);
            }
