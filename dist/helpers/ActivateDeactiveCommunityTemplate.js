...
exports.ActivateDeactiveCommunityTemplate = void 0;
class ActivateDeactiveCommunityTemplate {
    static getStatusChangeTemplate(communityData, userData, isActivation) {
        var _a;
    ...
    <div style="padding: 30px; background: white;">
      ...
      <div style="background: #f8f9fa; padding: 15px; border-radius: 6px; margin: 15px 0;">
        ...
        <div style="color: #212529; font-size: 15px;">
          ...
          ${((_a = communityData.creator.profile) === null || _a === void 0 ? void 0 : _a.institution_name) ? `<strong>Institution:</strong> ${communityData.creator.profile.institution_name}` : ''}
        </div>
      </div>
...
exports.ActivateDeactiveCommunityTemplate = ActivateDeactiveCommunityTemplate;
