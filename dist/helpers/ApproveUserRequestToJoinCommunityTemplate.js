...
exports.ApproveUserRequestToJoinCommunityTemplate = void 0;
class ApproveUserRequestToJoinCommunityTemplate {
    // Email to creator when user requests to join
    static getJoinRequestNotification(requestData, creatorData) {
        var _a, _b;
        return `
<!DOCTYPE html>
<html lang="en">
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; background: white;">
    ...
    <div style="padding: 30px; background: white;">
      ...
      <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0; border: 1px solid #e9ecef;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
          ...
          ${((_a = requestData.requester.profile) === null || _a === void 0 ? void 0 : _a.institution_name) ? `
          <div style="background: white; padding: 12px; border-radius: 6px; border: 1px solid #dee2e6;">
            <div style="color: #495057; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 6px;">
              🏛️ Institution
            </div>
          ...
          ${((_b = requestData.requester.profile) === null || _b === void 0 ? void 0 : _b.field_of_study) ? `
          <div style="background: white; padding: 12px; border-radius: 6px; border: 1px solid #dee2e6;">
            <div style="color: #495057; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 6px;">
              📚 Field of Study
            </div>
    ...
    static getMembershipApprovedTemplate(communityData, memberData) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
exports.ApproveUserRequestToJoinCommunityTemplate = ApproveUserRequestToJoinCommunityTemplate;
