...
class CollaborationEmailTemplates {
     ...
     */
    static getContributionApprovedTemplate(project, contributor, contribution) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; background: white;">
    ...
    static getCollaborationRequestTemplate(project, requester, request) {
        var _a, _b;
        return `
<!DOCTYPE html>
<html lang="en">
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; background: white;">
    ...
    <div style="padding: 30px; background: white;">
      ...
      <div style="background: #f8f9fa; padding: 15px; border-radius: 6px; margin: 15px 0;">
        ...
        <div style="color: #212529; font-size: 15px; line-height: 1.8;">
          ...
          ${((_a = requester.profile) === null || _a === void 0 ? void 0 : _a.institution_name) ? `
          <div style="margin: 8px 0;">
            <strong>Institution:</strong> ${requester.profile.institution_name}
          </div>
          ` : ''}
          ${((_b = requester.profile) === null || _b === void 0 ? void 0 : _b.department) ? `
          <div style="margin: 8px 0;">
     ...
     */
    static getRequestApprovedTemplate(project, requester) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; background: white;">
     ...
     */
    static getRequestRejectedTemplate(project, requester, rejectionReason) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
exports.CollaborationEmailTemplates = CollaborationEmailTemplates;
