...
exports.JoinRequestEmailTemplate = void 0;
class JoinRequestEmailTemplate {
    /**
     * Email to Community Creator - New Join Request
     */
    static getCreatorNotification(communityData, requesterData, creatorData, requestId) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; background: white;">
     ...
     */
    static getAdminNotification(communityData, requesterData, creatorData, adminData, requestId) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; background: white;">
     ...
     */
    static getRequesterConfirmation(communityData, requesterData) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; background: white;">
     ...
     */
    static getApprovalNotification(communityData, requesterData) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; background: white;">
     ...
     */
    static getRejectionNotification(communityData, requesterData, reason) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
exports.JoinRequestEmailTemplate = JoinRequestEmailTemplate;
