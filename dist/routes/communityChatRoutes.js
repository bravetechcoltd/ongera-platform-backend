...
const CommunityChatController_1 = require("../controllers/CommunityChatController");
...
router.get("/:communityId/messages", CommunityChatController_1.CommunityChatController.getCommunityMessages);
router.get("/:communityId/direct-conversation/:otherUserId", CommunityChatController_1.CommunityChatController.getDirectConversation);
// Upload file for chat
router.post("/:communityId/messages/upload", multer_1.default.single("file"), CommunityChatController_1.CommunityChatController.uploadChatFile);
// Get single message details
router.get("/:communityId/messages/:messageId", CommunityChatController_1.CommunityChatController.getMessage);
// Get online members (HTTP fallback)
router.get("/:communityId/members/online", CommunityChatController_1.CommunityChatController.getOnlineMembers);
// ==================== NEW ROUTES FOR DIRECT CHAT ====================
// Get community members available for direct chat
router.get("/:communityId/chat-members", CommunityChatController_1.CommunityChatController.getCommunityMembersForChat);
