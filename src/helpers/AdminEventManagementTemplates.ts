...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; background: white;">
    ...
    <div style="padding: 30px; background: white;">
      ...
      <!-- Action Button -->
      <a href="${process.env.FRONTEND_URL}/dashboard/user/event" 
         style="display: inline-block; background: #0158B7; color: white; text-decoration: none; padding: 14px 32px; border-radius: 6px; font-weight: 600; font-size: 15px; margin: 20px 0;">
        Manage Your Events
      </a>
  ...
  static getEventPostponedTemplate(
    event: Event,
    data: {
      oldDates: { start_datetime: Date; end_datetime: Date };
      newDates: { start_datetime: Date; end_datetime: Date };
      reason: string;
    },
    recipientType: 'organizer' | 'attendee'
  ): string {
   ...
   */
  static getOwnershipTransferredTemplate(
    event: Event,
    data: {
      oldOrganizer: User;
      newOrganizer: User;
    ...
    recipientType: 'old_organizer' | 'new_organizer'
  ): string {
      ...
      <body>
          <div class="container">
              ...
              <div class="content">
                  ...
                  <div style="text-align: center;">
                      <a href="${process.env.FRONTEND_URL}/dashboard/user/event/${event.id}" class="button">
