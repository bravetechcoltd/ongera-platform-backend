  ...
  <div style="max-width: 600px; margin: 0 auto; background: white;">
    ...
    <div style="padding: 30px; background: white;">
      ...
      <div style="margin: 30px 0;">
        <a href="${process.env.FRONTEND_URL}/dashboard/user/communities/${communityData.community_id}" 
        ...
        <a href="${process.env.FRONTEND_URL}/dashboard/user/communities/${communityData.community_id}/manage" 
        ...
        <a href="${process.env.FRONTEND_URL}/dashboard/user/communities/${communityData.community_id}/invite" 
           style="display: inline-block; background: white; color: #0158B7; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: 600; font-size: 14px; border: 2px solid #0158B7; margin: 8px;">
          👥 Invite Members
        </a>
      </div>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; background: white;">
    ...
    <div style="padding: 30px; background: white;">
      ...
      <!-- Action Buttons -->
      <div style="margin: 30px 0;">
        <a href="${process.env.FRONTEND_URL}/dashboard/user/communities/create" 
           style="display: inline-block; background: #0158B7; color: white; text-decoration: none; padding: 14px 32px; border-radius: 6px; font-weight: 600; font-size: 15px; margin: 8px 8px 8px 0;">
          🔄 Create New Community
        </a>

        <a href="${process.env.FRONTEND_URL}/dashboard/user/communities" 
           style="display: inline-block; background: white; color: #0158B7; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: 600; font-size: 14px; border: 2px solid #0158B7; margin: 8px;">
          🔍 Explore Communities
        </a>
      </div>
