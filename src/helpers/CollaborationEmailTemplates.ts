...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; background: white;">
    ...
    <div style="padding: 30px; background: white;">
      ...
      <!-- Action Button -->
      <a href="${process.env.FRONTEND_URL}/dashboard/user/research-projects/${project.id}?tab=contributions" 
  ...
  <div style="max-width: 600px; margin: 0 auto; background: white;">
    ...
    <div style="padding: 30px; background: white;">
      ...
      <div style="margin: 25px 0;">
        <a href="${process.env.FRONTEND_URL}/dashboard/user/research-projects/${project.id}/collaboration-requests" 
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; background: white;">
    ...
    <div style="padding: 30px; background: white;">
      ...
      <!-- Action Button -->
      <a href="${process.env.FRONTEND_URL}/dashboard/user/research-projects/${project.id}/contribute" 
         style="display: inline-block; background: #0158B7; color: white; text-decoration: none; padding: 14px 32px; border-radius: 6px; font-weight: 600; font-size: 15px; margin: 20px 0;">
        Start Contributing
      </a>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; background: white;">
    ...
    <div style="padding: 30px; background: white;">
      ...
      <!-- Action Button -->
      <a href="${process.env.FRONTEND_URL}/dashboard/user/research-projects?collaboration_status=Seeking Collaborators" 
         style="display: inline-block; background: #0158B7; color: white; text-decoration: none; padding: 14px 32px; border-radius: 6px; font-weight: 600; font-size: 15px; margin: 20px 0;">
        Find Other Projects
      </a>
