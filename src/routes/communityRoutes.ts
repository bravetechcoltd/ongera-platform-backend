...
router.put("/:id", authenticate, upload.single("cover_image"), CommunityController.editCommunity);

router.get("/:id/can-edit", authenticate, CommunityController.canEditCommunity);
