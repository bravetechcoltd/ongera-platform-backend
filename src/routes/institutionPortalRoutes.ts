...
// ==================== INSTITUTION RESEARCH PORTAL — Dashboard ====================
router.get("/dashboard", authenticate, InstitutionResearchController.dashboard);
...
router.post(
  "/members/add-student",
  authenticate,
  InstitutionPortalController.addStudentToInstitutionPortal
);

router.post(
  "/members/add-instructor",
  authenticate,
  InstitutionPortalController.addInstructorToInstitutionPortal
);

router.get(
  "/portal/students",
  authenticate,
  InstitutionPortalController.getInstitutionPortalStudents
);

router.get(
  "/portal/instructors",
  authenticate,
  InstitutionPortalController.getInstitutionPortalInstructors
);

router.get(
  "/portal/dashboard",
  authenticate,
  InstitutionPortalController.getInstitutionPortalDashboard
);

router.delete(
  "/members/students/:studentId",
  authenticate,
  InstitutionPortalController.removeStudentFromInstitutionPortal
);

router.delete(
  "/members/instructors/:instructorId",
  authenticate,
  InstitutionPortalController.removeInstructorFromInstitutionPortal
);
